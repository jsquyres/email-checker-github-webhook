...
# git-commit-email-checker-config.inc file
##############################################################################
##############################################################################

if (!is_file("git-commit-email-checker-config.inc")) {
    my_die("Cannot find git-commit-email-checker.php's config file.");
}
require_once "git-commit-email-checker-config.inc";
